	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        if (false) {
	          ...
	          if (obj.headerParams) {
	            ...
	            try {
	              for (var _iterator = Object.getOwnPropertyNames(obj.headerParams)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                ...
	                if (headerName.toLowerCase() === "origin") {} else {
	          ...
	          if (obj.headerParams) {
	            ...
	            try {
	              for (var _iterator2 = Object.getOwnPropertyNames(obj.headerParams)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                var _headerName = _step2.value;

	                var _headerValue = obj.headerParams[_headerName];
	                console.log("additional header " + _headerName + " set with " + _headerValue);
	                if (_headerName.toLowerCase() === "origin") {
	                  xhr.withCredentials = true;
	                } else {
	                  xhr.setRequestHeader(_headerName, _headerValue);
	                }
	              }
	            } catch (err) {
